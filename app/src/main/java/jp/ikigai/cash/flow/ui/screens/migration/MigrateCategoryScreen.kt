...
import jp.ikigai.cash.flow.ui.components.bottomsheets.MigrateCategoryLandscapeSheet
import jp.ikigai.cash.flow.ui.components.bottomsheets.MigrateCategorySheet
...
fun MigrateCategoryScreen(
    navigateBack: () -> Unit,
    migrate: (CategoryWithTransactionMetadata) -> Unit,
...
fun EntryProviderScope<NavKey>.migrateCategoryScreen(backStack: NavBackStack<NavKey>) {
    entry<MigrateCategoryRoute> { route ->
