...
sealed class Event(@StringRes val message: Int) {
    ...
    object AccountCategoryMethodRequired :
    ...
    object AccountCategoryRequired : Event(R.string.category_account_required_error_label)
    object AccountMethodRequired : Event(R.string.method_account_required_error_label)
    ...
    object AccountRequired : Event(R.string.account_required_error_label)
    object AccountMapRequired : Event(R.string.account_map_required_error_label)
