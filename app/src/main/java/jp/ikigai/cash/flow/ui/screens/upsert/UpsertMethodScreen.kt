            ...
            firstColContent = {
                Column(
                    ...
                    UpsertScreenBottomAppBar(
                        ...
                        deleteClick = if (methodId > 0 && enabled) {
                            {
...
fun EntryProviderScope<NavKey>.upsertMethodScreen(backStack: NavBackStack<NavKey>) {
    entry<UpsertMethodRoute> { route ->
